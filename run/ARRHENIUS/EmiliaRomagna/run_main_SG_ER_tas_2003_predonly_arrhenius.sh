...
GCM='ERAI'
#EXPNAME='wsmto'
EXPNAME='wsmo_lnoise0.1'
#EXPNAME='wsmo_tile_lnoise0.1'
...
apptainer run --nv \
    ...
    $CONTAINER \
    python3 $SRC/main.py -c /home/fuxing/Climulator/config/ARRHENIUS/${DOMAIN}/config_main_SG_${DOMAIN}_${VARIABLE}_${EXPNAME}_${GCM}_${TESTYEAR}_predonly_arrhenius.ini 
